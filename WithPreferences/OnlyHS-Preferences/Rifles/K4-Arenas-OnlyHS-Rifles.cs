...
namespace K4ArenaOnlyHSRiflePreference;

[MinimumApiVersion(205)]
public class PluginK4ArenaOnlyHSRiflePreference : BasePlugin
{
    public static int RoundTypeID { get; private set; } = -1;
    public override string ModuleName => "K4-Arenas Addon - OnlyHS Rifles";
    ...
    public override void OnAllPluginsLoaded(bool hotReload)
    {
        ...
        if (checkAPI != null)
        {
            RoundTypeID = checkAPI.AddSpecialRound("Headshoty - Karabiny", 1, true, RoundStart, RoundEnd);
    ...
    public static CsItem GetRandomRifle()
    {
        List<CsItem> rifleItems =
        [
            CsItem.AK47,
            CsItem.M4A1S,
            CsItem.M4A1,
        ...
        return rifleItems[Random.Shared.Next(0, rifleItems.Count)];
}
    ...
    public void RoundStart(List<CCSPlayerController>? team1, List<CCSPlayerController>? team2)
    {
        ...
        foreach (var p in team1){
            ...
            var rifle = playerPrefernce["Rifle"] ?? GetRandomRifle();
            p.RemoveWeapons();
