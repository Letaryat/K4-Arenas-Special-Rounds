...
namespace K4ArenaNoscopeScout;

[MinimumApiVersion(205)]
public class PluginK4ArenaNoscopeScout : BasePlugin
{
    public static int RoundTypeID { get; private set; } = -1;
    public override string ModuleName => "K4-Arenas Addon - Noscope - Scout";
    ...
    public override void OnAllPluginsLoaded(bool hotReload)
    {
        ...
        if (checkAPI != null)
        {
            RoundTypeID = checkAPI.AddSpecialRound("Noscope Scout", 1, true, RoundStart, RoundEnd);
